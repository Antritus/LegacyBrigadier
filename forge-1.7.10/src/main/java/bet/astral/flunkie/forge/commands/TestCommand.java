...
import bet.astral.flunkie.command.arguments.BlockArgument;
import bet.astral.flunkie.forge.LegacyBrigadierV1_7_10;
import com.mojang.brigadier.builder.LiteralArgumentBuilder;

import static bet.astral.flunkie.command.CommandManager.argument;
import static bet.astral.flunkie.command.CommandManager.command;

public class TestCommand {
    public static LiteralArgumentBuilder<CommandSourceStack> create(){
        return command("/test")
                .then(argument("block", BlockArgument.blockArg()))
                .executes((s)->{
